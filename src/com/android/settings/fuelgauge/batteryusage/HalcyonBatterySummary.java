...
public class HalcyonBatterySummary extends PowerUsageBase
        implements BatteryTipPreferenceController.BatteryTipListener {

    static final String TAG = "HalcyonBatterySummary";
    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        return BatteryMenuControllers(context, this /* fragment */, getSettingsLifecycle());
    }

    private static List<AbstractPreferenceController> BatteryMenuControllers(
            Context context, HalcyonBatterySummary fragment, Lifecycle lifecycle) {
        final List<AbstractPreferenceController> controllers = new ArrayList<>();
        controllers.add(new BatteryMenuController(context));
        return controllers;
    }
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.halcyon_battery_summary;
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.halcyon_battery_summary);
}
